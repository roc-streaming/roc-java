#include "com_github_rocproject_roc_ChannelSet.h"
...
JNIEXPORT jint JNICALL Java_com_github_rocproject_roc_ChannelSet_getRocChannelSetStereo(JNIEnv *env, jclass thisObj) {
